...
public class PropertyEditorFrame_AboutBox extends JDialog implements ActionListener {
    ...
    private void jbInit() throws Exception  {
        //imageLabel.setIcon(new ImageIcon(PropertyEditorFrame_AboutBox.class.getResource("[Your Image]")));
        this.setTitle("About");
        setResizable(false);
